...
urlpatterns = [
    ...
    url(r'^join/(?P<id>[0-9]{4})/', views.join_chatroom, name="join-chatroom"),
    url(r'^leave/(?P<id>[0-9]{4})/', views.leave_chatroom, name="leave-chatroom"),
